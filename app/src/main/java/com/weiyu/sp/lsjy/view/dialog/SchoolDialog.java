...
public class SchoolDialog extends UpdatePersonalBaseDialog {
    Dialog dialog;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.school);
