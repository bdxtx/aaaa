package com.weiyu.sp.lsjy.utils.download;
...
import static com.weiyu.sp.lsjy.utils.download.AppUtil.sApp;
...
public class BGAUpgradeUtil {
    ...
    public static void installApk(File apkFile) {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.M) {
            Uri uri=FileProvider.getUriForFile(sApp, getFileProviderAuthority(), apkFile);
