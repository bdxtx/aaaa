...
public class IdentityDialog extends UpdatePersonalBaseDialog {
    Dialog dialog;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.identity);
        ...
        tv_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (length<15||length>18){
                    ToastUtil.show("身份证长度15到18位之间");
                    return;
                }
                UpdatePersonalPresenter updatePersonalPresenter=new UpdatePersonalPresenter();
                updatePersonalPresenter.attachView(IdentityDialog.this);
                Map<String,String>map=new HashMap<>();
                map.put("identity",et_name.getText().toString());
